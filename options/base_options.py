...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', type=str, default='/data/lisa/data/sim2real/mujoco_data4.h5', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--batchSize', type=int, default=8, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=163, help='scale images to this size')
    ...
    def parse(self):
        ...
        self.opt.name = self.opt.name + '_' + self.opt.which_model_netG
